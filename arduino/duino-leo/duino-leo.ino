...
void mouse(char *m,char *val){
	if( strcmp(m,"be") == 0 ){ // Mouse.begin()
		Mouse.begin();
	}
	if( strcmp(m,"cl") == 0 ){ // Mouse.click()
		if( strcmp(val,"rig") == 0 ){
			Mouse.click(MOUSE_RIGHT);
		}else if( strcmp(val,"mid") == 0 ){
			Mouse.click(MOUSE_MIDDLE);
		}else{
			Mouse.click(MOUSE_LEFT);
		}
	}
	if( strcmp(m,"en") == 0 ){ // Mouse.begin()
		Mouse.end();
	}
}
