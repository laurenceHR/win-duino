...
<<<<<<< HEAD
	  ...
	  self.serial.open(function (error) {
		  if ( error ) {
			self.log('info','>>>>> Error to Open');
		  } else {
			self.log('info','>>>>> Port Open');
		  }
	  });
=======

      self.log('info', 'binding serial events');
>>>>>>> ffa33dda93445f5fd4ea891488ecd687457b052e
...
>>>>>>> ffa33dda93445f5fd4ea891488ecd687457b052e
  ...
  if (!err) {
	found = temp;
<<<<<<< HEAD
	self.log('info', '>>>>> win-duino: found board at ' + this.device+ " with "+this.baudrate);	
=======
